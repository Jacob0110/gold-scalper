    ...
    const initData = async () => {
      try {
        ...
        ws.onmessage = (e) => {
          ...
          if (ch[ch.length - 1]?.time === candle.time) ch[ch.length - 1] = candle;
          else ch.push(candle);
          ...
          if (
            logicalRange &&
            candlesRef.current.length - logicalRange.to < 2
          ) {
            ts.scrollToRealTime();
          }
    ...
    >
      ...
      <div style={styles.gridRow1}>
        ...
        <StatCard
          ...
          color="#fbbf24"
          sub={
            parseFloat(marketData.emaFast) >
            parseFloat(marketData.emaSlow)
              ? 'Bull'
              : 'Bear'
          }
        />
            ...
            <div style={styles.btStat}>
              ...
              <span
                style={{
                  ...styles.btValue,
                  color:
                    backtestResult.winRate > 50 ? '#4ade80' : '#ef4444',
                }}
              >
